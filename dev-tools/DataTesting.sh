...
RunFunceble () {
    ...
    then
        ...
        PyFunceble --ci -h -m -p $(nproc --ignore=1) -db --database-type mariadb -ex --plain --dns 127.0.0.1 \
            --autosave-minutes 40 --share-logs --http --idna --ci-branch 'pyfunceble-processing' \
